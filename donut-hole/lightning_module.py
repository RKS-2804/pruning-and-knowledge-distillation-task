...
class DonutModelPLModule(pl.LightningModule):
    def __init__(self, config):
        ...
        if self.config.get("teacher_model_path", None):
            ...
            print(f"Loaded teacher model from {self.config.teacher_model_path}")
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.teacher_model is not None:
            ...
            distillation_alpha = self.config.get("distillation_alpha", 0.7)
            ...
            # Combine losses
            loss = distillation_alpha * distillation_loss + (1 - distillation_alpha) * loss
